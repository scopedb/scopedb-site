...
It's possible to support more algebraic data types in the future, such as enums, tuples and structs. We are excited to see how users leverage variant data types to build their applications. If you have any questions or feedback, please feel free to reach out to us. We'd love to hear from you!
