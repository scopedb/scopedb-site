/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 7653fce7bf8cc6247a331e11f5120acc)
// Runtime types generated with workerd@1.20250709.0 2025-06-27 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PUBLIC_CALCOM_LINK: string;
		PUBLIC_CONTACT_LINK: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_CALCOM_LINK" | "PUBLIC_CONTACT_LINK">> {}
}
