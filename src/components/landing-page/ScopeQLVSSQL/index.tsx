...
export default function ScopeQLVSSQL() {
    ...
    return (
        <div className="bg-[#F9F9F9] rounded-[16px] py-[16px] px-[16px] flex flex-col max-w-[720px] ">
            {/* Tab Navigation */}
            <div
                className="flex text-[14px] flex-nowrap gap-[24px] overflow-x-auto px-[8px] text-[var(--color-secondary)]">
            ...
            <div className="mt-[16px] flex flex-col flex-1">
                ...
                <div className="flex-1 bg-[#FFFFFF] rounded-[16px] p-[20px]"
                    ...
                    <div className="font-[14px] overflow-x-auto w-[650px]">
                        <ShikiHighlighter
                            theme="min-light"
